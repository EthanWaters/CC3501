...
// void LSM9DS1Driver::initializeAK8963() {
//     // Power down the magnetometer and enable Fuse ROM access
//     uint8_t mode = 0x0F;
//     selectChip();
...
//     // Exit Fuse ROM access mode and enable continuous measurement mode
//     mode = 0x16;
//     selectChip();
//     spi_write_blocking(SPI_PORT, &mode, 1);
//     deselectChip();
...
void LSM9DS1Driver::readRawData(int16_t accel[3], int16_t gyro[3], int16_t mag[3]) {
    uint8_t buffer[6];
